/* Two-socket public-ABI acceptance source, retained from Jackstay's reference
 * source at 0e622f5284e8e5bdb4a496751c5b6db3e2649a34 (MIT OR Apache-2.0).
 * The upstream example now uses source bootstrap. This fixture keeps testing
 * Katzensteg's separate media/input connections against the current library. */
