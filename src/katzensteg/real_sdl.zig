...
extern fn ks_real_SDL_GetModState() c_int;
extern fn ks_real_SDL_GetKeyFromScancode(scancode: c_int) c_int;
extern fn ks_real_SDL_GetScancodeFromKey(key: c_int) c_int;
