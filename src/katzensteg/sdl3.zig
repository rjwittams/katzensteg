...
pub extern fn SDL_GetKeyFromScancode(scancode: c_int, modifiers: u16, key_event: bool) c_int;
pub extern fn SDL_GetScancodeFromKey(key: c_int, modifiers: ?*u16) c_int;
