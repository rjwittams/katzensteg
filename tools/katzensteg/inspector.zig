...
pub const FrameRecord = inspect_model.FrameRecord;
pub const ResourceKind = inspect_model.ResourceKind;
pub const ResourceRecord = inspect_model.ResourceRecord;
...
pub const makeAlias = inspect_model.makeAlias;
